...
Redux::set_section( Minimog_Redux::OPTION_NAME, array(
	...
	'fields'     => array(
		array(
			'id'      => 'header_style_09_content_width',
			'type'    => 'select',
		...
		array(
			'id'      => 'header_style_09_header_above_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_info_list_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_info_list_secondary_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_search_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_login_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_wishlist_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_cart_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_currency_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_language_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_social_networks_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_text_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_09_button_enable',
			'type'    => 'button_set',
