...
Redux::set_section( Minimog_Redux::OPTION_NAME, array(
	...
	'fields'     => array(
		array(
			'id'      => 'header_style_08_content_width',
			'type'    => 'select',
		...
		array(
			'id'      => 'header_style_08_header_above_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_info_list_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_info_list_secondary_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_search_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_login_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_wishlist_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_cart_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_currency_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_language_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_social_networks_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_text_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_08_button_enable',
			'type'    => 'button_set',
