...
Redux::set_section( Minimog_Redux::OPTION_NAME, array(
	...
	'fields'     => array(
		array(
			'id'      => 'header_style_03_content_width',
			'type'    => 'select',
		...
		array(
			'id'      => 'header_style_03_header_above_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_info_list_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_info_list_secondary_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_search_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_login_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_wishlist_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_cart_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_currency_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_language_switcher_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_social_networks_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_text_enable',
			'type'    => 'button_set',
		...
		array(
			'id'      => 'header_style_03_button_enable',
			'type'    => 'button_set',
